...
import classes from "./BookmarksEdit.module.css";
    ...
    <div className={classes.BookmarksEdit}>
      ...
      <form onSubmit={saveBookmark}>
        <div className="form-group row">
          <label htmlFor="titleBookmark" className="col-sm-2 col-form-label">
            Title
          </label>
          <input
            id="titleBookmark"
        ...
        <div className="form-group row">
          <label htmlFor="linkBookmark" className="col-sm-2 col-form-label">
            Link
          </label>
          <input
            id="linkBookmark"
        ...
        <div className="form-group row">
          <label htmlFor="tagsBookmark" className="col-sm-2 col-form-label">
            Tags
          </label>
          <input
            id="tagsBookmark"
        ...
        <div className="text-center">
          <button
            className={classes.EditBtn + " btn btn-success"}
            disabled={isInvalid}
            type="submit"
          >
            Save Link
          ...
          <span
            className={classes.EditBtn + " btn btn-info"}
            onClick={toggleModal}
          >
            Cancel
          </span>
