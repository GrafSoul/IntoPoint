...
class SettingsPage extends Component {
	...
	render() {
		const {
			newUserName, email, emailError, passwordError, passwordOne,
			passwordTwo, authUser, userSetName, userName, authInitial, complete,
			updateProperty, modal, toggleInfoModal
		} = this.props;
			...
			<div className={classes.SettingsPage + ' container'}>
				...
				<ModalWindow
					...
					<div className="text-center">
						...
						<div className="text-center">
							<button className="btn btn-success" onClick={toggleInfoModal}>Ok</button>
						</div>
					</div>
				</ModalWindow>
...
export default compose(withAuthorization(authCondition), connect(mapStateToProps, mapDispatchToProps))(SettingsPage);
