...
import classes from './RssList.css'
...
class RssList extends Component {
	...
	render() {
		...
		const {userFeeds, activeFeed, rssAddFeeds, activeLink, amountFeeds, removeFeed, editFeed} = this.props;
		...
		return (
			<div className={classes.RssList + ' col-md-3'}>
				<h5 className={classes.RssListTitle}>Feeds <span className={classes.Amount}>({amountFeeds})</span></h5>
