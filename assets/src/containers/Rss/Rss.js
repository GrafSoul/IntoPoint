  ...
  render() {
    ...
    return (
      <div className={classes.RssReader + " container"}>
          ...
          <div className="row">
            ...
            <div className="col-6 text-lg-right col-md-3">
              <button
                ...
                onClick={this.handleModalAddFeed}
              >
        ...
        <ModalWindow isOpen={modal} toggleModal={rssToggleModal}>
          {status === "edit" && (
            <RssEdit
            ...
            <div className="text-center">
              ...
              <div className={classes.RemoveBtnGroup + " text-center"}>
                <button
                  ...
                  onClick={() => this.handleRemoveFeed(activeId)}
                >
                  Yes
                </button>
                <button className="btn btn-info" onClick={rssToggleModal}>
                  Cancel
                </button>
              </div>
            </div>
...
const mapDispatchToProps = (dispatch) => ({
  ...
  rssUpdateField: (field, set) =>
    dispatch(actionCreators.rssUpdateField(field, set)),
  rssViewFeed: (id, title, link) =>
    dispatch(actionCreators.rssViewFeed(id, title, link)),
  rssEditFeed: (id, title, link) =>
    dispatch(actionCreators.rssEditFeed(id, title, link)),
