...
import classes from './NotesView.css';
...
class NotesView extends Component {
	...
	componentDidMount() {
		...
		$(document).ready(function() {
			$('code').addClass('javascript').each(function(i, block) {
	...
	render() {
		const {idNote, title, text, tags, editNote, removeNote, setStatus} = this.props;
					...
					<Scrollbars
						...
						<div className={classes.NoteItem}>
							...
							<div className={classes.Icons}>
								...
								<span title="Return to the List" onClick={() => setStatus('listNotes')}>
