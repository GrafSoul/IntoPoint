...
class Header extends Component {
	...
	render() {
		const {authUser, userName, activeLink, sideDrawer,linkSelected, activeSideDrawer} = this.props;

		return (
			<header>
				<div className={classes.Header + ' navbar navbar-expand-md fixed-top shadow-lg'}>
					<div className="container">
						...
						<Link to={routes.HOME}
						      ...
						      className={classes.Brand}>IntoPoint</Link>
