...
import classes from "./NavigationAuth.module.css";
    ...
    <ul className="nav">
      <li className="nav-item">
        <Link
          ...
          className={
            "nav-link " +
            (currentLocation === routes.BOOKMARKS
      ...
      <li className="nav-item">
        <Link
          ...
          className={
            "nav-link " +
            (currentLocation === routes.RSS ? classes.NavigationActiveLink : "")
          }
          to={routes.RSS}
        >
          <i className="fas fa-rss" /> RSS Reader
        </Link>
      </li>
      ...
      <li className="nav-item">
        <Link
          ...
          className={
            "nav-link " +
            (currentLocation === routes.SETTINGS
              ? classes.NavigationActiveLink
              : "")
          }
          to={routes.SETTINGS}
      ...
      <li>
        <SignOut sideDrawer={showSideDrawer} />
      </li>
    </ul>
  );
};
