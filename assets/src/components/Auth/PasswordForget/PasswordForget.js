					...
					{!forgetPassword ?
						<div className="card-body text-center">
							<form onSubmit={this.onSubmit}>
								...
								<p className="center-align">Remember your password?
						...
						<div className="card-body text-center">
							...
							<p>After the recovery, log in to the system <Link to={routes.SIGN_IN}>Sign In</Link></p>
						</div>
					}
				</div>
			</div>
...
export default connect(mapStateToProps, mapDispatchToProps)(withRouter(PasswordForgetPage));
