  ...
  render() {
    ...
    return (
      <div className={classes.Notes + " container"}>
          ...
          <div className="row">
            ...
            <div className="col-6 text-lg-right col-md-3">
              <button
                ...
                onClick={this.handleModalAddNote}
              >
        ...
        <ModalWindow isOpen={modal} toggleModal={noteToggleModal}>
          <div className="text-center">
            ...
            <div className={classes.RemoveBtnGroup + " text-center"}>
              <button
                ...
                onClick={() => this.handleRemoveNote(idNote)}
              >
                Yes
              </button>
              <button className="btn btn-info" onClick={noteToggleModal}>
                Cancel
              </button>
            </div>
          </div>
...
const mapDispatchToProps = (dispatch) => ({
  ...
  updateField: (field, set) =>
    dispatch(actionCreators.notesUpdateField(field, set)),
  ...
  searchTagsList: (value, tags) =>
    dispatch(actionCreators.notesSearchTagsList(value, tags)),
  noteEdit: (id, text, title, tags) =>
    dispatch(actionCreators.noteEdit(id, text, title, tags)),
  noteView: (id, text, title, tags) =>
    dispatch(actionCreators.noteView(id, text, title, tags)),
