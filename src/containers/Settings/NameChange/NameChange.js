...
import classes from "./NameChange.module.css";
...
class NameChangeForm extends Component {
  ...
  getDataUser = () => {
    ...
    db.onceGetUserName(authUser.uid).then((snapshot) =>
      userSetName(snapshot.val())
    );
  };
  ...
  render() {
    ...
    const isInvalid = newUserName === userName || newUserName === "";
        ...
        <div className="card-body text-center">
          <form className="form-inline" onSubmit={this.onSubmit}>
            <div className="form-group mb-2">
              <label htmlFor="changeNameLabel" className="sr-only">
                Current Name
              </label>
              <input
                type="text"
            ...
            <div className="form-group mx-sm-3 mb-2">
              <label htmlFor="changeName" className="sr-only">
                New Name
              </label>
              <input
                ...
                onChange={(event) =>
                  updateProperty("username", event.target.value)
                }
                type="text"
